    ...
    useEffect(() => {
        ...
        <Formik
            ...
            validationSchema={Yup.object({
                ...
                password: Yup.string()
                    .min(1, 'Password es muy corto - debe contener por lo menos un caracter.')
            ...
            {(formik) => (
                <Container maxW='lg' py={{ base: '12', md: '24' }} px={{ base: '0', md: '8' }} minH='4xl'>
                    ...
                    <Stack spacing='6'>
                        ...
                        <Heading size={headingBR}>Iniciar sesión con tu cuenta</Heading>
                        <HStack spacing='1' justify='center'>
                            <Text color='muted'>Aun no tienes una cuenta ?</Text>
